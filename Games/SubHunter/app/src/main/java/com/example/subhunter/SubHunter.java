...
public class SubHunter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Tell Android to set our drawing as the view
        for this app
         */
    ...
    void draw(){
        ...
        // Changes the paint color to black
        paint.setColor(Color.argb(255, 0, 0, 0));

        // Draw the vertical lines of the grid
        canvas.drawLine(blockSize * 1, 0, blockSize * 1, numberVerticalPixels - 1,
                paint);

        // Draw the horizontal lines of the grid
        canvas.drawLine(0, blockSize * 1, numberHorizontalPixels - 1,blockSize * 1,
                paint);
